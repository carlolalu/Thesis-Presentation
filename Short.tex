...
\begin{frame}
\frametitle{12. The classification theorem}
\begin{block}{Theorem}
...
\item $\Z_2\times\Z_2$,
\item $\Z$,
\item the infinite dihedral group $\Z_2\ltimes_\phi\Z$,
\item the lamplighter group $\Z\wr\Z_2=\Z\ltimes\Z_{2}^{(\Z)}$.
\end{itemize}
\end{block}
\end{frame}

\begin{frame}
\frametitle{13. Sketch of proof}
