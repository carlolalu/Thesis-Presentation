...
\begin{frame}
\frametitle{7. Application to automata}
\begin{block}{Definition}
...
$$(h,z_1)*(k,z_2)=(h+_{\Z_2}k,(-1)^{k}z_1+z_2),$$
...
\end{tikzpicture}
\end{figure}
where $x_{ij}\in\{a,b\}$ and $\tau^{i_1},\tau^{i_2}\in\symm(\abece)=\symm(\{0,1\})$. There are 64 possibilities.
\end{block}\pause
